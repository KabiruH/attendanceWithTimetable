...
import { Ban, Search, CheckCircle, AlertTriangle, History } from "lucide-react";
  ...
  return (
    <div className="space-y-4">
      <Alert>
        ...
        <AlertDescription>
          Blocked users cannot select classes or subjects. They can still view their timetable 
          but cannot make any changes to their assignments.
        </AlertDescription>
      </Alert>
